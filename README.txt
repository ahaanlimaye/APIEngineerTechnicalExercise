The final step in order to start working with Gordian is to complete the exercise below. This is a practical challenge similar to real problems you would solve as part of this team, but should be much simpler than the take-home you've already solved. 
